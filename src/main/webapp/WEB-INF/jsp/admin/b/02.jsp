                ...
                <table class="tbl_1">
                    ...
                    <tbody>
	                    ...
	                    <jsp:include page="/file/mainScreenUploadImageFile.do">
	                        <jsp:param name="category" value="Main/ko"/>
	                        <jsp:param name="imageSize" value="620px * 338px"/>
	                    </jsp:include>
	
	                    <jsp:include page="/file/multiUploadFile.do">
	                        <jsp:param name="category" value="Bbs/ko"/>
	                    </jsp:include>
	                    <tr>
...
<script type="text/javascript">
    let b_02 = (function () {
        ...
        let init = function () {
            $container.find('form').data('formdata', {clturTypeCode: 'KO'});
            ...
            BIT.validate($container.find('form'), 'formdata', function (response) {
                if (response.IsSucceed) {
                    if ($.getUrlVar('bbsPid') != null) {
                        location.href = '<c:url value="/admin/index.do?pageid=b_01&"/>' + window.location.href.slice(window.location.href.indexOf('&') + 1);
                    } else {
                        location.href = '<c:url value="/admin/index.do?pageid=b_01"/>';
                    }
                }
            });
        };
