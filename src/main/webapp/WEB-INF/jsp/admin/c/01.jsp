...
<div class="container" id="divContainer">
    ...
    <div class="contents" id="C_01">
        <div class="gnb01">
            ...
            <div class="btn_area">
                <a class="btn_register" name="btnRegist" href="<c:url value='/admin/index.do?pageid=c_02' />">등록하기</a>
            </div>
        </div>
    </div>
</div>
...
<script type="text/x-tmpl" id="tmplBbsList">
    ...
    <tr data-data="{%=JSON.stringify(data)%}">
        ...
        <td><a href='<c:url value="/admin/index.do?pageid=c_02&bbsPid="/>{%= data.bbsPid %}'>{%= BIT.htmlDecode(data.sj) %}</a></td>
