        ...
        <div class="wrap_1296">
            <div class="news_wrap">
            	<div class="filter_wrap">
            		...
            		<button type="button" value="Daygen News">Daygen News</button>
            ...
            return BIT.callAjax('<c:url value="/frontbbs/getBbsList.do" />', 'post', param, function (response) {
                if (response.IsSucceed) {
                    if (response.totalrecords > 0) {
                        ...
                        $container.find('[name=BbsList]').empty().append("<div style='text-align: center; line-height: 100px; font-size: 20px;color: #3E3E3E;font-weight:500'>We are preparing the news.</div>");
                        $container.find('[name=btnMore]').hide();
                    }
                }
            });
