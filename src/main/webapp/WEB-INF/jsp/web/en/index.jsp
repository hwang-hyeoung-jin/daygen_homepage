...
<head>
  ...
  <!--  <meta property="og:description" content="데이젠, daygen, 헬스케어, 건강기능식품, 지초, 감태, 퍼플루트, 홍경천, 홍경천더블임팩트, 덴티케어플렉스" />-->
    ...
    <link rel="stylesheet" href="<c:url value='/css/web/layoutEN.css?ver=210812'/>">
    <link rel="stylesheet" href="<c:url value='/css/web/commonEN.css'/>">
    ...
    <div class="layout">
                        ...
                        <div class="prd_box">
                            <div class="box_wrap prd01">
                                ...
                                <ul class="prd_left_sub">
                                    <li class="animated">
                                        <img src='<c:url value='/images/webEN/index/prd0101.png'/>' alt="Health Functional Food" />
                                    </li>
                                    <li class="animated">
                                        <img src='<c:url value='/images/webEN/index/prd0102.png'/>' alt="Conventional Food" />
                                    </li>
                                    <li class="animated">
                                        <img src='<c:url value='/images/webEN/index/prd0103.png'/>' alt="Other Products" />
                                    </li>
                                </ul>
                            </div>
                            <em></em>
                            <div class="box_wrap prd02">
                                ...
                                <ul class="prd_right_sub">
                                    <li class="animated">
                                        <img src='<c:url value='/images/webEN/index/prd0201.png'/>' alt="Lithospermum Erythrorhizon" />
                                    </li>
                                    <li class="animated">
                                        <img src='<c:url value='/images/webEN/index/prd0202.png'/>' alt="Ecklonia Cava" />
                                    </li>
                                    <li class="animated">
                                        <img src='<c:url value='/images/webEN/index/prd0203.png'/>' alt="Discovery of  Raw Materials" />
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="contbox">
                        ...
                        <div class="right">
                            <div class="cont1" data-scroll="toggle(.fromBottomIn, .fromBottomOut)">
                                <p>Lithospermum Erythrorhizon<br/>Extract</p>
                            </div>
                            <div class="cont2" data-scroll="toggle(.fromBottomIn, .fromBottomOut)">
                                <p>Sea Trumpet<br/>Extract</p>
                            </div>
                        </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide slide">
                            	<a href='<c:url value='/en/index.do?pageid=c_01_01#prd01'/>'>
                                    <img src='<c:url value='/images/webEN/index/cont03_prd02.png'/>' alt="Purpleroot Hong Gyeong-cheon double impact" />
                                </a>
                            </div>
                            <div class="swiper-slide slide">
                                <a href='<c:url value='/en/index.do?pageid=c_01_01#prd02'/>'>
                                    <img src='<c:url value='/images/webEN/index/cont03_prd03.png'/>' alt="Purpleroot Denticare flex" />
                                </a>
                            </div>
                            <div class="swiper-slide slide">
                            	<a href='<c:url value='/en/index.do?pageid=c_01_01#prd03'/>'>
                                    <img src='<c:url value='/images/webEN/index/cont03_prd04.png'/>' alt="Purpleroot Jointcare flex" />
                                </a>
                            </div>
                            <div class="swiper-slide slide">
                                <a href='<c:url value='/en/index.do?pageid=c_01_01#prd04'/>'>
                                    <img src='<c:url value='/images/webEN/index/cont03_prd05.png'/>' alt="Purpleroot Womencare flex" />
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="footer">
            <div class="wrap_1620">
                ...
                <div class="info">
                    <p>RM A421 Gwanggyo UmiNewv B/D, 338, Gwanggyojungang-ro, Suji-gu, Yongin-si, Gyeonggi-do, Republic of Korea<br />
