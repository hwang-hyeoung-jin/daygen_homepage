...
<div class="container contact">
    ...
    <div class="content sub_cont01">
        <div class="wrap_1620">
            <div class="map_area">
                <!--<div id="map_daygen" style="width:100%; height:620px;"></div>-->
                <div id="map" style="width:1620px;height:620px;"></div>
    ...
    <div class="content sub_cont02">
        <div class="wrap_1296">
            <p class="tit"><img src='<c:url value='/images/webEN/contact/tit.png'/>' alt="Daygen Headquarters"></p>
            <ul data-scroll="toggle(.fromBottomIn, .fromBottomOut)">
                <li data-scroll="toggle(.fromBottomIn, .fromBottomOut)">
                    <em>
                        <img src='<c:url value='/images/web/contact/ico_address.png'/>' alt="address">
                    </em>
                    <p>RM A421 Gwanggyo UmiNewv B/D, 338,<br/>Gwanggyojungang-ro, Suji-gu, Yongin-si,<br/>Gyeonggi-do, Republic of Korea</p>
                </li>
                <li data-scroll="toggle(.fromBottomIn, .fromBottomOut)">
                    <em>
                        <img src='<c:url value='/images/web/contact/ico_call.png'/>' alt="call">
                    </em>
                    <p>+82-31-215-8814<br/><span>TEL</span></p>
                </li>
                <li data-scroll="toggle(.fromBottomIn, .fromBottomOut)">
                    <em>
                        <img src='<c:url value='/images/web/contact/ico_fax.png'/>' alt="fax">
                    </em>
