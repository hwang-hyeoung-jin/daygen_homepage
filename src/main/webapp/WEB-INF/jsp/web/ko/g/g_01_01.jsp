...
<div class="container store">
    ...
    <div class="content sub_cont01" id="G_01_01">
        <div class="map_top">
            <!-- 지도 width 100% height 977-->
            <div class="" id="mainMap" style="width:100%;height: 977px"></div>
            <div class="map_bg">
	            <div class="wrap_1296">
	                <div class="map_search">
	                    ...
	                    <h5>검색 결과</h5>
	                    <ul style="height:654px;" class="scrollbar" name="ulSubParmacyList">
	                        <li style='height: 50px;text-align: center;line-height:50px;font-size:18px'>검색결과가 없습니다.</li>
	                    </ul>
        ...
        <div class="wrap_1296">
            ...
            <div class="search_top">
                <select class="sel_common mr10" name="ctprvn">
...
<script type="text/javascript">
    let g_01_01 = (function () {
            ...
            return BIT.callAjax('<c:url value="/frontparmacy/getParmacyList.do" />', 'post', subSearchData, function (response) {
                if (response.IsSucceed) {
                    if (response.totalrecords > 0) {
                        $container.find('[name=ulSubParmacyList]').empty().append(tmpl('tmplSubParmacyList', response.rows));
                        ...
                        $container.find('[name=ulSubParmacyList]').empty().append("<li style='height: 50px;text-align: center;line-height:50px;font-size:18px'>검색결과가 없습니다.</li>");
            ...
            return BIT.callAjax('<c:url value="/frontparmacy/getParmacyList.do" />', 'post', searchData, function (response) {
                if (response.IsSucceed) {
                    if (response.totalrecords > 0) {
                        ...
                        $container.find('[name=tbodyParmacyList]').empty().append("<tr><td colspan='6' style='height: 50px;text-align: center;line-height:50px;font-size:18px'>검색결과가 없습니다.</td></tr>");
        ...
        let registerEventHandler = function () {
            ...
            $container.find('[name=tbodyParmacyList]').on("click", ".btn_map", function () {
                $('.dim').show();
                $('.layer_pop').fadeIn();
            ...
            $container.find('[name=ulSubParmacyList]').on('click', 'li', function () {
