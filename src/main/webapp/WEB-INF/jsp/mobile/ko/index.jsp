...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/css/mobile/layout.css?ver=210812'/>">
            ...
            <div class="content cont02 sub_cont" id="visual01">
                <div class="wrap_1296">
                    <div class="contbox" data-scroll="toggle(.fromBottomIn, .fromBottomOut)">
                        ...
                        <div class="prd_box">
                            <span class="prd_left">건강기능식품</span>
                            <ul class="prd_left_sub">
                                <li>
                                    <img src='<c:url value='/images/mobile/index/prd0101.png'/>' alt="건강기능식품, 일반식품, 기타제품" />
                                </li>
                            </ul>
                            <em></em>
                            <span class="prd_right">소재사업</span>
                            <ul class="prd_right_sub">
                                <li>
                                    <img src='<c:url value='/images/mobile/index/prd0201.png'/>' alt="지초, 감태, 원료 발굴" />
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <a href='<c:url value='/ko/index.do?pageid=c_01_01#prd01'/>'>
                                    <img src='<c:url value='/images/mobile/index/cont03_prd02.png'/>' alt="퍼플루트 홍경천 더블 임팩트" />
                                </a>
                            </div>
                            <div class="swiper-slide">
                                <a href='<c:url value='/ko/index.do?pageid=c_01_01#prd02'/>'>
                                    <img src='<c:url value='/images/mobile/index/cont03_prd03.png?ver=210608'/>' alt="퍼플루트 덴티케어 플렉스" />
                                </a>
                            </div>
                            <div class="swiper-slide">
                                <a href='<c:url value='/ko/index.do?pageid=c_01_01#prd03'/>'>
                                    <img src='<c:url value='/images/mobile/index/cont03_prd04.png'/>' alt="퍼플루트 관절케어 플렉스" />
                                </a>
                            </div>
                            <div class="swiper-slide">
                                <a href='<c:url value='/ko/index.do?pageid=c_01_01#prd04'/>'>
                                    <img src='<c:url value='/images/mobile/index/cont03_prd05.png'/>' alt="퍼플루트 우먼케어 플렉스" />
                                </a>
                            </div>
                        </div>
                    </div>
