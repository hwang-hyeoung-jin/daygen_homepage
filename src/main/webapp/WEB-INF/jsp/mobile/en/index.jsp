...
<head>
    ...
    <meta property="og:image" content="/images/og_imageEN.png" />
    ...
    <link rel="canonical" href="https://m.daygen.co.kr/">
    ...
    <link rel="stylesheet" href="<c:url value='/css/mobile/layoutEN.css?ver=210812'/>">
    <link rel="stylesheet" href="<c:url value='/css/mobile/commonEN.css'/>">
...
<body>
                        ...
                        <td class="todayPop01_top ">
                            <div>
                            	<a href="https://www.daynshop.com/" target="_blank">
                                	<!-- <img src='<c:url value='/images/popup/landing_pageEn.jpg'/>' alt="데이젠팝업" /> -->
                                </a>
                            </div>
                        </td>
                    </tr>
                        ...
                        <td class="todayPop_bottom01">
                            <ul>
                                <li class="bottom_l">
                                    ...
                                    <label for="inputTodayChk01">Do not open this window today</label>
                                </li>
                                <li class="bottom_r">
                                    <a href="javascript:;" class="layer_pop_close_01">Close
                                    </a>
                                </li>
                            </ul>
                        </td>
    ...
    <div class="layout">
         <%= SiteMapLoader.getLocalNavigationBar("Front_en", new HashMap<String, String>() {{
                    put("gnbYn", "Y");
                }}, 1) %>
        <div class="header">
            <div class="top">
                <a id="btnLnbClose" class="btn_lnb_close" href="javascript:;">close</a>
                <a id="btnHam" class="btn_ham" href="javascript:;">menu</a>
                <h1 class="logo">
                    <a href='<c:url value='/en/default.do'/>'></a>
                </h1>
                <div class="language">
                    <a href='<c:url value="/ko/default.do" /> '>KOR</a>
                </div>
            </div>
        </div>
        ...
        <div class="container index" id="Main">
                ...
                <div class="swiper-container visual-slide">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img src='<c:url value='/images/mobile/index/slide01.jpg'/>' />
                        </div>
                        <div class="swiper-slide">
                            <img src='<c:url value='/images/mobile/index/slide02.jpg'/>' />
                        </div>
                        <div class="swiper-slide">
                            <img src='<c:url value='/images/mobile/index/slide03.jpg'/>' />
                        </div>
                        <div class="swiper-slide">
                            <img src='<c:url value='/images/mobile/index/slide04.jpg'/>' />
                        </div>
                    </div>
                </div>
                <div class="cont_txt">
                    <div class="wrap_1296">
                        <img src='<c:url value='/images/mobile/index/visual_logo.png'/>' />
                        <p>An Expert Healthcare Company developing<br/>health functional products based on distinct<br/>materials and patented technologies</p>
                    </div>
                </div>
                <span class="deco_scroll animated infinite fadeInDown">
                    <img src='<c:url value='/images/mobile/common/ico_scroll.png'/>' />
                </span>
            </div>
            <div class="content cont02 sub_cont" id="visual01">
                <div class="wrap_1296">
                    <div class="contbox" data-scroll="toggle(.fromBottomIn, .fromBottomOut)">
                        <p><strong>Business Field</strong></p>
                        <div class="prd_box">
                            <span class="prd_left"></span>
                            <ul class="prd_left_sub">
                                <li>
                                    <img src='<c:url value='/images/mobileEN/index/prd0101.png'/>' alt="Health Functional Food, Conventional Food, Other Products" />
                                </li>
                            </ul>
                            <em></em>
                            <span class="prd_right"></span>
                            <ul class="prd_right_sub">
                                <li>
                                    <img src='<c:url value='/images/mobileEN/index/prd0201.png'/>' alt="Lithospermum Erythrorhizon, Ecklonia Cava, Discovery of  Raw Materials" />
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="wrap_1296">
                    <div class="contbox">
                        <div class="left" data-scroll="toggle(.fromBottomIn, .fromBottomOut)">
                            <h3>TECHNOLOGY</h3>
                            <a href='<c:url value='/en/index.do?pageid=b_01_01'/>'>More<em></em></a>
                        </div>
                        <div class="right">
            ...
            <div class="content cont04 sub_cont" id="visual03">
                <div class="contbox">
                    <h3>PRODUCTS</h3>
                    <div class="swiper-container prd-slide">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <a href='<c:url value='/en/index.do?pageid=c_01_01#prd01'/>'>
                                    <img src='<c:url value='/images/mobileEN/index/cont03_prd02.png'/>' alt="Purpleroot Hong Gyeong-cheon double impact" />
                                </a>
                            </div>
                            <div class="swiper-slide">
                                <a href='<c:url value='/en/index.do?pageid=c_01_01#prd02'/>'>
                                    <img src='<c:url value='/images/mobileEN/index/cont03_prd03.png?ver=210608'/>' alt="Purpleroot Denticare flex" />
                                </a>
                            </div>
                            <div class="swiper-slide">
                                <a href='<c:url value='/en/index.do?pageid=c_01_01#prd03'/>'>
                                    <img src='<c:url value='/images/mobileEN/index/cont03_prd04.png'/>' alt="Purpleroot Jointcare flex" />
                                </a>
                            </div>
                            <div class="swiper-slide">
                                <a href='<c:url value='/en/index.do?pageid=c_01_01#prd04'/>'>
                                    <img src='<c:url value='/images/mobileEN/index/cont03_prd05.png'/>' alt="Purpleroot Womencare flex" />
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="content cont05 sub_cont" id="visual04">
                <div class="wrap_1296">
                    ...
                    <div class="news_list">
                    	<ul name="BbsList"></ul>
                        <a href='<c:url value='/en/index.do?pageid=e_01_01'/>' class="btn_more">More<em></em></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="footer">
            <div class="wrap_1620">
                ...
                <div class="info">
                    <p>RM A421 Gwanggyo UmiNewv B/D, 338, Gwanggyojungang-ro, Suji-gu,<br/>Yongin-si, Gyeonggi-do, Republic of Korea<br />
	                    <strong>TEL </strong>+82-31-215-8814<em class="space"></em><strong>FAX</strong>+82-31-215-8815
	                </p>
    ...
    <script>
        ...
        $(document).ready(function () {
            $('.prd_box span').on('click', function () {
                $('.prd_box ul').hide()
                $(this).next().show();
                $('.prd_box span').removeClass('on')
                $(this).addClass('on');
                $('.prd_box em').addClass('on')
            });
        });
    </script>
	...
	<li data-data="{%=JSON.stringify(data)%}">
		<a href='<c:url value="/en/index.do?pageid=e_01_02&bbsPid="/>{%= data.bbsPid %}'>
			<div class="thumb">
            ...
            return BIT.callAjax('<c:url value="/frontbbs/getBbsList.do" />', 'post', param, function (response) {
                if (response.IsSucceed) {
                    if (response.totalrecords > 0) {
                        ...
                        $container.find('[name=BbsList]').empty().append("<div style='text-align: center; line-height: 100px; font-size: 15px'>We are preparing the news.</div>");
                    }
                }
            });
        };
