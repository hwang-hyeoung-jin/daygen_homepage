	...
	<div class="layout">
		<div class="error">
		    <div class="wrap_1296">
		        <ul class="error_area">
		        	<li>
		        		<img src="<c:url value='/images/mobile/common/error_logo.png'/>" alt="daygen">
		        	</li>
		            <li>
		                <h3 class="name">403</h3>
		                <p class="tit">A temporary error has occurred due to<br/>abnormal access or unknown values.  </p>
		                <p class="desc">You are not authorized to view the page or<br/>we can’t confirm the page.<br/>Try again in a normal access way. </p>
