		...
		<div class="error">
		    <div class="wrap_1296">
		        <ul class="error_area">
		            ...
		            <li>
		                <h3 class="name">500</h3>
		                <p class="tit">A temporary error occurred.</p>
		                <p class="desc">We are sorry for the inconvenience.<br/>
		                Please turn back to the main page and try again.</p>
